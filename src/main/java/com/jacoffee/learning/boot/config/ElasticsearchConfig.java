package com.jacoffee.learning.boot.config;

import com.jacoffee.learning.boot.elasticsearch.CustomResultMapper;
...
@Configuration
// 指定扫描repository路径
@EnableElasticsearchRepositories(basePackages = "com.jacoffee.learning.boot.elasticsearch.repository")
